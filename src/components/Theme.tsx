...
export default function Theme(){
    return(
        <section className="relative w-full min-h-screen z-10 px-5" id='theme'>
            ...
            <div className="flex flex-col lg:flex-row gap-3 lg:gap-10 mb-10 lg:mx-20 lg:absolute -left-40 xl:-left-48 top-12 z-10 w-full items-center lg:items-start justify-center lg:justify-end">
