...
export default function MainPartners() {
  return (
    <section className="flex flex-col items-center justify-center max-w-7xl w-full py-10 lg:py-20 px-6 mx-auto gap-8 lg:gap-14 mt-40">
      <h2
      ...
      <div className="gap-16 flex flex-wrap w-full justify-center">
