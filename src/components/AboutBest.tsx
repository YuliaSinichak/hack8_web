...
export default function AboutBest(){
    return(
        <section className="min-h-screen flex flex-col justify-center items-center xl:items-start xl:justify-start w-full py-20 relative z-10">
            ...
            <div className="bg-black border xl:border-l-0 rounded-xl xl:rounded-l-0 p-3 px-2 lg:px-8 xl:pl-0 max-w-2xl my-10 z-10 mx-7 xl:mx-0">
                <div className=" bg-hack-dark-green rounded-xl text-white xl:rounded-l-0 flex flex-col gap-5 p-8 px-5 lg:px-10 text-xs lg:text-lg">
                    <p>
